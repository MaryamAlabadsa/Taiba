...
{{--                    <img alt="Logo" src="{{asset('admin/media/logos/logo-1-dark.svg')}}" class="h-25px logo" />--}}
            ...
            <!--end::Brand-->
            <!--begin::Aside menu-->
                    @include('agent.layouts.partials.aside')
            <!--end::Aside menu-->
            <!--begin::Footer-->
...
{{--                                <!--end::Quick links-->--}}
                                ...
                                <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                                    ...
                                    <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                                        <img src="{{auth('agent')->user()->avatar_url}}" alt="user" />
                                    </div>
                                    <!--begin::Menu-->
                                        ...
                                        <div class="menu-item px-3">
                                            <div class="menu-content d-flex align-items-center px-3">
                                                ...
                                                <div class="symbol symbol-50px me-5">
                                                    <img alt="Logo" src="{{auth('agent')->user()->avatar_url}}" />
                                                </div>
                                                <!--end::Avatar-->
                                                <!--begin::Username-->
                                                <div class="d-flex flex-column">
                                                    <div class="fw-bolder d-flex align-items-center fs-5">{{auth('agent')->user()->name}}
                                                        <span class="badge badge-light-success fw-bolder fs-8 px-2 py-1 ms-2">مندوب</span></div>
                                                    <a href="#" class="fw-bold text-muted text-hover-primary fs-7">{{auth('agent')->user()->email}}</a>
                                                </div>
                                                <!--end::Username-->
                                            </div>
                                        </div>
...
{{--                                        </div>--}}
                                        ...
                                        <div class="menu-item px-5">
                                            ...
                                            <a class="menu-link px-5" href="{{ route('agent.logout') }}"
